...
import joelbits.preprocessing.InjectionModule;
...
import joelbits.preprocessing.utils.ProjectNodeCreator;
...
public final class GitHubPreProcessor implements PreProcessor {
    ...
    private byte[] parseFile(String codeRepository, String mostRecentCommitId, String path) throws Exception {
        String fullPath = FrameworkUtil.jarPath() + codeRepository + File.separator + path;
